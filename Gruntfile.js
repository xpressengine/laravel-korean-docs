    ...
    grunt.registerMultiTask('build', 'build gh-pages for jeykll', function () {
        ...
        this.files.forEach(function (files) {
            ...
            files.src.forEach(function (file) {
                ...
                content = content.replace(/<!--chak-comment-(.+)-->/g, '<div class="chak-comment-wrap"><div class="chak-comment-widget" data-chak-group="laravel" data-chak-apikey="582898af492efbcdd53990e1c6ccb89d-laravel-korean-docs-$1" ><i class="xi-message"></i> <strong>클릭</strong>하여 의견을 공유할 수 있습니다. ( 총 <span class="count"><i class="xi-spinner-5 xi-spin"></i></span>개의 의견이 있습니다. )</div></div>');
